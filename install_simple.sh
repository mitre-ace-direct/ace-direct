...
printf "\n"
printf "IMPORTANT: Create the ~/ace-direct/dat/config.json file before executing this installation script.\n"
printf "\n"
...
if [ ! -f ${CONFIG_FILE} ]; then
  printf "error - ${CONFIG_FILE} does not exist. Please create it first.\n"
  exit 1
fi
